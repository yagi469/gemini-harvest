...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(HarvestRepository harvestRepository) {
        return args -> {
            ...
            harvestRepository.save(new Harvest("りんご狩り", "シャキシャキのりんごを収穫！", "長野県", 1800.0));
            harvestRepository.save(new Harvest("さくらんぼ狩り", "初夏の味覚、真っ赤なさくらんぼを堪能！", "山形県", 2500.0));
            harvestRepository.save(new Harvest("トマト収穫体験", "もぎたて新鮮なトマトを味わおう！", "熊本県", 1200.0));
            harvestRepository.save(new Harvest("ブルーベリー摘み", "目に良いブルーベリーをたくさん摘もう！", "北海道", 1700.0));
        };
    }
}
