            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
              <div className="flex justify-between items-center">
                ...
                <nav className="flex items-center space-x-4 sm:space-x-8">
                  <Link
                    href="/harvests/all"
                    className="text-gray-300 hover:text-emerald-400 font-medium transition-colors duration-300 relative group hidden sm:block"
                  >
                    すべての体験
                  ...
                  <SignedOut>
                    ...
                    <SignUpButton mode="modal">
                      <button className="px-3 py-1 sm:px-4 sm:py-2 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105">
                        新規登録
                      </button>
                    </SignUpButton>
                  </SignedOut>
